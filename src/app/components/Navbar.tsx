...
export default function Navbar({ siteContent }: NavbarProps) {
  ...
  const tagline = siteContent?.tagline || 'Official Rippa Dealer - PNW';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <a href={`tel:${phone.replace(/\D/g, '')}`} className="flex items-center text-slate-300 hover:text-cyan-400 transition-colors font-medium">
      ...
      {isMenuOpen && (
        <div className="lg:hidden bg-slate-800 border-t border-slate-700">
          <div className="px-4 py-4 space-y-3">
            ...
            <a href={`tel:${phone.replace(/\D/g, '')}`} className="block text-slate-300 hover:text-cyan-400 py-2 font-medium">
